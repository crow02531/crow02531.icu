...
有望了！在[Wolftail与Riceball](/2021/10/19/wolftail-and-riceball/ '点击跳转')中我曾讲述了Wolftail面临的最大问题，现在这个问题有望解决，“假EntityPlayer实例”方法表现得比我预期的更好，现在使用的渲染方法是顶层代码自己写，底层调用mc基本的渲染框架。
